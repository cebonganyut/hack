...
try:
    ...
    Pathlist = [
        ...
        '/wp-content/themes/bute/lang.php',
        
        '/wp-content/plugins/core-plugin/include.php',
        
        '/wp-content/themes/pridmag/db.php?u',
        
        '/wp-includes/css/dist/editor/fxp.php',
        
        '/wp-content/plugins/seoplugins/db.php?udb.php?u',
        ...
        '/wp-admin/images/class.api.php#888xyz999',
        
        '/wp-admin/js/widgets/class.api.php#888xyz999',
        
        '/.well-known/pki-validation/class_api.php#888xyz999',
        
        '/class_api.php#888xyz999',
        
        '/class.api.php#888xyz999'

        
        '/BIBIL_0DAY.php/wp-content/themes/travel/issue.php',
        
        '/wp-admin/maint/plugins.php',
