    ...
    for path in paths:
        ...
        try:
            ...
            if response.status_code == 200:
                response_text = response.text.lower()  # Convert response text to lowercase
                
                # Check for FTP-related content in the response text
                ftp_keywords = ["uploadonsave", "upload_on_save", "save_before_upload"]
                if any(keyword in response_text for keyword in ftp_keywords):
                ...
                db_keywords = ["db_host", "db_host"]
                if any(keyword in response_text for keyword in db_keywords):
